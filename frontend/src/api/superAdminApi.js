...
export const exportAdminsPdf = () =>
  axiosInstance.get("/super-admin/reports/admins/pdf", { responseType: "blob" });

export const exportAdminsExcel = () =>
  axiosInstance.get("/super-admin/reports/admins/excel", { responseType: "blob" });
...
export const getProfile = () =>
  axiosInstance.get("/super-admin/profile");
