...
const COLORS = ["#1e4f73", "#9BB3C7", "#8FA9BE", "#c0392b", "#2ecc71", "#e67e22", "#9b59b6", "#1abc9c"];
...
const Reports = () => {
  ...
  const paginatedData = userGrowthData.slice((growthPage - 1) * DAYS_PER_PAGE, growthPage * DAYS_PER_PAGE);
  ...
  if (loading && !reportData) {
    return <div className="reports-page"><h2>Loading...</h2></div>;
  }
      ...
      <div className="reports-card">
        ...
        <div className="chart-section">
          <div className="chart-top">
            ...
            <select className="chart-filter" value={MONTHS[selectedMonth - 1]} onChange={(e) => handleMonthChange(e.target.value)}>
              {MONTHS.map((m) => (
          ...
          <div className="chart-meta">
            <span className="total-label">Total No of Patients : <strong>{totalPatients}</strong></span>
          ...
          {paginatedData.length > 0 ? (
            <ResponsiveContainer width="100%" height={260}>
              <BarChart data={paginatedData} barSize={18}>
                ...
                <Tooltip />
                <Bar dataKey="patients" fill="#1e4f73" radius={[4, 4, 0, 0]} name="Patients" />
                <Bar dataKey="doctors" fill="#9BB3C7" radius={[4, 4, 0, 0]} name="Doctors" />
              </BarChart>
            </ResponsiveContainer>
          ) : (
            <p style={{ textAlign: "center", padding: "40px", color: "#999" }}>No data available for this month</p>
          )}
        ...
        <div className="chart-section">
          ...
          <div className="pie-wrapper">
            ...
            {cityData.length > 0 ? (
              ...
              <p style={{ textAlign: "center", padding: "40px", color: "#999" }}>No distribution data available</p>
            )}
          </div>
