...
namespace MedScope.Infrastructure.Migrations
{
    ...
    [Migration("20260427160533_AddHospitalSpecialties")]
    partial class AddHospitalSpecialties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.BookingSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.HospitalSpecialty", b =>
                {
                    b.Property<int>("HospitalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.PasswordResetOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Specialty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Doctor", b =>
                {
                    ...
                    b.HasOne("MedScope.Domain.Entities.Specialty", "Specialty")
                        .WithMany()
