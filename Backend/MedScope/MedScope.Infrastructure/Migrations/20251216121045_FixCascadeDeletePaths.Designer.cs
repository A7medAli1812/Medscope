...
namespace MedScope.Infrastructure.Migrations
{
    ...
    [Migration("20251216121045_FixCascadeDeletePaths")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Doctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("MedScope.Domain.Entities.Doctor", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedScope.Domain.Entities.Patient", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Doctor", b =>
                {
                    b.HasOne("MedScope.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("MedScope.Domain.Entities.Doctor", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MedScope.Domain.Entities.Patient", b =>
                {
                    b.HasOne("MedScope.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("MedScope.Domain.Entities.Patient", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
